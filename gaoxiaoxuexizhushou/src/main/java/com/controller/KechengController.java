...
//                            kechengEntity.setKechengName(data.get(0));                    //资源标题 要改的
//                            kechengEntity.setKechengTypes(Integer.valueOf(data.get(0)));   //资源类型 要改的
//                            kechengEntity.setKechengPhoto("");//详情和图片
//                            kechengEntity.setKechengVideo(data.get(0));                    //资源视频 要改的
//                            kechengEntity.setKechengFile(data.get(0));                    //课件下载 要改的
//                            kechengEntity.setBanjiTypes(Integer.valueOf(data.get(0)));   //班级 要改的
//                            kechengEntity.setJiaoshiId(Integer.valueOf(data.get(0)));   //资源教师 要改的
