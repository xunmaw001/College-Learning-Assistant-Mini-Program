    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(jiaoanxinxi !=null){
            ...
            BeanUtils.copyProperties( jiaoanxinxi , view );//把实体数据重构到view中
...
//            jiaoanxinxi.setJiaoshiId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        if(jiaoanxinxiEntity==null){
            jiaoanxinxiService.updateById(jiaoanxinxi);//根据id更新
            return R.ok();
        }else {
            return R.error(511,"表中有相同数据");
        }
    ...
    */
    ...
    public R save( String fileName, HttpServletRequest request){
        ...
        try {
            List<JiaoanxinxiEntity> jiaoanxinxiList = new ArrayList<>();//上传的东西
...
//                            jiaoanxinxiEntity.setJiaoanxinxiName(data.get(0));                    //教案标题 要改的
//                            jiaoanxinxiEntity.setJiaoanxinxiTypes(Integer.valueOf(data.get(0)));   //教案类型 要改的
//                            jiaoanxinxiEntity.setJiaoanxinxiFile(data.get(0));                    //课件下载 要改的
//                            jiaoanxinxiEntity.setJiaoshiId(Integer.valueOf(data.get(0)));   //教师 要改的
//                            jiaoanxinxiEntity.setJiaoanxinxiContent("");//详情和图片
//                            jiaoanxinxiEntity.setInsertTime(date);//时间
//                            jiaoanxinxiEntity.setCreateTime(date);//时间
