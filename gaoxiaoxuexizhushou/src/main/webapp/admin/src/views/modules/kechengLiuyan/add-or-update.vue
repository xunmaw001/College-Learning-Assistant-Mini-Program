    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="评论内容" prop="kechengLiuyanText">
                        <el-input type="textarea"  :readonly="ro.kechengLiuyanText" v-model="ruleForm.kechengLiuyanText" placeholder="评论内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.kechengLiuyanText" label="评论内容" prop="kechengLiuyanText">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if (this.role != "管理员"){
                this.ro.kechengId = true;//课程信息
                this.ro.yonghuId = true;//用户
                this.ro.kechengLiuyanText = true;//评论内容
            }
