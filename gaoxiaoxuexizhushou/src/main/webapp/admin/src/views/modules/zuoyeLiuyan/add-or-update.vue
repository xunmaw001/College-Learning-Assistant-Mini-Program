    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="评论内容" prop="zuoyeLiuyanText">
                        <el-input type="textarea"  :readonly="ro.zuoyeLiuyanText" v-model="ruleForm.zuoyeLiuyanText" placeholder="评论内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.zuoyeLiuyanText" label="评论内容" prop="zuoyeLiuyanText">
                            <span v-html="ruleForm.zuoyeLiuyanText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if (this.role != "管理员"){
                this.ro.zuoyeId = true;//作业
                this.ro.yonghuId = true;//用户
                this.ro.zuoyeLiuyanText = true;//评论内容
            }
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`zuoyeLiuyan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.zuoyeLiuyanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
