	...
	export default {
		...
		methods: {
			...
			async upCallback(mescroll) {
				let res = await this.$api.list('jiaoshiLiuyan', {
					page: mescroll.num,
					limit: mescroll.size,
					jiaoshiId: this.id
				});
			...
			// 添加评论
			async onCommentTap() {
                this.$utils.jump(`../jiaoshiLiuyan/add-or-update?jiaoshiId=${this.id}`)
            },
		}
	}
</script>
